...
const PaymentPage = () => {
  ...
  // Pontos principais e avenidas que definem a zona de delivery
  const deliveryBoundaryPoints = [
    { name: "Avenida Marginal (Norte)", lat: -25.928, lng: 32.605 },
    { name: "Avenida Marginal (Sul)", lat: -25.968, lng: 32.585 },
    { name: "Avenida Dona Alice", lat: -25.95, lng: 32.62 },
    { name: "Baixa da Cidade", lat: -25.96, lng: 32.585 },
    { name: "Praça dos Heróis", lat: -25.9553, lng: 32.5892 },
    { name: "Universidade Pedagógica", lat: -25.932, lng: 32.608 },
    { name: "Avenida Julius Nyerere", lat: -25.94, lng: 32.61 },
    { name: "Avenida 24 de Julho", lat: -25.965, lng: 32.59 },
    { name: "Avenida Samora Machel", lat: -25.95, lng: 32.595 },
    { name: "Avenida Vladimir Lenine", lat: -25.952, lng: 32.588 },
    { name: "Avenida Patrice Lumumba", lat: -25.945, lng: 32.585 },
    { name: "Avenida Acordos de Lusaka", lat: -25.938, lng: 32.592 },
    { name: "Avenida Mao Tse Tung", lat: -25.928, lng: 32.595 },
    { name: "Mercado Central", lat: -25.958, lng: 32.592 },
    { name: "CFM (Estação Central)", lat: -25.96, lng: 32.58 },
    { name: "Porto de Maputo", lat: -25.965, lng: 32.575 },
  ];

  // Polígono da zona de delivery (aproximado pelas avenidas principais)
  const deliveryPolygon = [
    { lat: -25.928, lng: 32.605 }, // Marginal Norte
    { lat: -25.932, lng: 32.608 }, // UP
    { lat: -25.94, lng: 32.61 }, // Julius Nyerere
    { lat: -25.95, lng: 32.62 }, // Dona Alice
    { lat: -25.96, lng: 32.615 }, // Polana
    { lat: -25.965, lng: 32.6 }, // Polana Sul
    { lat: -25.968, lng: 32.585 }, // Marginal Sul
    { lat: -25.965, lng: 32.575 }, // Porto
    { lat: -25.96, lng: 32.58 }, // CFM
    { lat: -25.955, lng: 32.585 }, // Centro
    { lat: -25.945, lng: 32.585 }, // Patrice Lumumba
    { lat: -25.938, lng: 32.592 }, // Acordos de Lusaka
    { lat: -25.928, lng: 32.595 }, // Mao Tse Tung
  ...
  useEffect(() => {
    const initMaps = () => {
      if (window.google && mapRef.current && detailMapRef.current) {
        ...
        // Adicionar linhas das avenidas principais no mapa detalhado
        const mainAvenues = [
          // Avenida Marginal
          [
            { lat: -25.928, lng: 32.605 },
            { lat: -25.968, lng: 32.585 },
          ],
          // Avenida Dona Alice
          [
            { lat: -25.94, lng: 32.615 },
            { lat: -25.95, lng: 32.62 },
          ],
          // Avenida Samora Machel
          [
            { lat: -25.945, lng: 32.59 },
            { lat: -25.955, lng: 32.595 },
          ],
          // Avenida 24 de Julho
          [
            { lat: -25.96, lng: 32.585 },
            { lat: -25.965, lng: 32.595 },
          ],
        ];

        mainAvenues.forEach((avenue) => {
